...
const Login: React.FC = () => {
  ...
  const [loginMode, setLoginMode] = useState<'google' | 'mock'>('google');
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 border border-gray-600 rounded-md bg-white/10 backdrop-blur-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="test@goalpay.com"
                    />
                  </div>
                </div>
